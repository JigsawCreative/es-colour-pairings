<?php
    ...
    // Fetch post content
    $content = ESCP_DisplayPairings::get_post_content( get_the_ID() );
...
<div class="page-content">
    ...
    <?php echo '<nav class="breadcrumbs"><a href="../">Home</a> <i class="fa-solid fa-chevron-right"></i> <a href="/'. $content['parent_slug'] .'">' . ucwords($content['parent_name']) . '</a> <i class="fa-solid fa-chevron-right"></i> ' . get_the_title() . '</nav>';?>
